<?php 
    ...
    if (isset($_POST['add_product'])) {
        ...
        $select_products_name = mysqli_query($conn, "SELECT name FROM `products` WHERE name = '$product_name'") or die('query failed');
    ...
    if(isset($_POST['update_product'])) {
        ...
        $update_image_tmp_name = $_FILES['_update_image']['tmp_name'];
